...
namespace F2GTraining.Services
{
    public class ServiceSQS
    {
        ...
        {
            //DEBEMOS INDICAR EL TIEMPO PARA EL SONDEO Y EL NUMERO
            //DE MENSAJES QUE VA A RECUPERAR
            ...
            if (response.HttpStatusCode == System.Net.HttpStatusCode.OK)
            {
                ...
                {
                    //TENEMOS UNA COLECCION LLAMADA Message
                    ...
                    foreach (Message msj in messages)
                    {
                        ...
                        Nota data =
                            JsonConvert.DeserializeObject<Nota>(json);
                        output.Add(data);
                    }
                    return output;
                }
